package com.uclk.shani.youseelk.taglib;
import android.graphics.Color;

//this is a file from the library
public class Constants {
    ...
    public static final float DEFAULT_TAG_RADIUS = 20;
    public static final int DEFAULT_TAG_LAYOUT_COLOR = Color.parseColor("#ffb300");
